...
{
	[DataContract(Name = "CommerceResultTrans", Namespace = "http://schemas.datacontract.org/2004/07/Victory.DataLayer.Serialization")]
	public class CommerceResultTrans
	{
		[DataMember]
		public System.Collections.Generic.List<Victory.DataLayer.Serialization.CommerceItemTrans> CommerceItems {get; set;}
		[DataMember]
		...
		[DataMember]
		public System.Collections.Generic.List<Victory.DataLayer.Serialization.OwnedCarTrans> PurchasedCars {get; set;}
		[DataMember]
